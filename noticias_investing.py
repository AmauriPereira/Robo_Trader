...
headers.update({'User-Agent': 'Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:91.0) Gecko/20100101 Firefox/91.0'})
...
if data.status_code == requests.codes.ok:
    ...
    blocos = ((info.find('table', {'id': 'economicCalendarData'})).find('tbody')).findAll('tr',
                                                                                          {'class': 'js-event-item'})
